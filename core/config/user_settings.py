...
SETTINGS_APP_NAME = "самокодер"
DEFAULT_TELEMETRY_ENDPOINT = "https://api.samokoder.io/telemetry"
...
def resolve_config_dir() -> Path:
    ...
    determined.
    """
    # Prioritize a specific environment variable, especially for containerized environments
    config_dir_env = getenv("SAMOKODER_CONFIG_DIR")
    if config_dir_env:
        return Path(config_dir_env)

    # Fallback logic for desktop environments
