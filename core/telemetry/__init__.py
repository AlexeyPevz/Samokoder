...
from samokoder.core.config.user_settings import settings
from samokoder.core.config.version import get_version
...
class Telemetry:
    """
    Samokoder telemetry data collection.
    ...
    def clear_data(self):
        ...
        self.data = {
            ...
            # Samokoder VSCode Extension version
            "extension_version": None,
            # Is extension used
            "is_extension": False,
            # The default LLM provider and model
            "provider": config.agent.get("default", AgentLLMConfig()).provider.value,
            "model": config.agent.get("default", AgentLLMConfig()).model,
            # Initial prompt
            "initial_prompt": None,
            # Updated prompt
            "updated_prompt": None,
        ...
        self.data.update(
            {
                ...
                "elapsed_time": 0,
                # Total number of lines created by Samokoder
                "created_lines": 0,
    ...
    async def send(self, event: str = "samokoder-core-telemetry"):
        """
