...
from samokoder.core.config.config import LocalIPCConfig
from samokoder.core.log import get_logger
from samokoder.core.ui.base import UIBase, UIClosedError, UISource, UserInput
...
class IPCClientUI(UIBase):
    """
    UI adapter for Samokoder VSCode extension IPC.
    """
    ...
    async def start(self):
        ...
        try:
            ...
            log.error(f"Can't connect to the Samokoder VSCode extension: {err}")
            return False
