...
from samokoder.core.config.config import SPEC_WRITER_AGENT_NAME
from samokoder.core.db.models import Complexity
from samokoder.core.db.models.project_state import IterationStatus
from samokoder.core.llm.parser import StringParser
...
class SpecWriter(BaseAgent):
    ...
    async def analyze_spec(self, spec: str) -> str:
        msg = (
            "Ваше описание проекта кажется немного коротким. "
            "Чем лучше вы опишете проект, тем лучше самокодер поймет, что вы хотите построить.\n\n"
