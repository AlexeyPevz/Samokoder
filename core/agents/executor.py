...
from samokoder.core.proc.exec_log import ExecLog
...
from samokoder.core.ui.base import AgentSource, UIBase, UISource
...
class Executor(BaseAgent):
    ...
    async def run(self) -> AgentResponse:
        ...
        await self.ui.send_process_status(status_code)
