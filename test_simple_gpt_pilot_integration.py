#!/usr/bin/env python3
"""
Упрощенный тест интеграции с GPT-Pilot
Проверяет работу упрощенного адаптера и wrapper
"""
...
async def test_simple_adapter():
    """Тестирует упрощенный адаптер GPT-Pilot"""
    print("🧪 Тестирование упрощенного адаптера GPT-Pilot...")
...
async def test_simple_wrapper():
    """Тестирует упрощенный wrapper GPT-Pilot"""
    print("\n🧪 Тестирование упрощенного wrapper GPT-Pilot...")
...
async def main():
    ...
    print("🧪 Тестирование упрощенной интеграции с GPT-Pilot")
    print("=" * 60)
    
    # Тест 1: Адаптер
    adapter_success = await test_simple_adapter()
    
    # Тест 2: Wrapper
    wrapper_success = await test_simple_wrapper()
    ...
    if adapter_success and wrapper_success and flow_success:
        print("\n🎉 Все тесты упрощенной интеграции прошли успешно!")
        print("✅ GPT-Pilot упрощенная интеграция работает")
        return True
    else:
        print("\n❌ Некоторые тесты упрощенной интеграции не прошли")
        return False
