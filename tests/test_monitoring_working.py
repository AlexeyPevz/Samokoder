...
class TestMonitoringServiceWorking:
    """Рабочие тесты для MonitoringService"""
...
class TestMonitoringGlobalFunctionsWorking:
    """Рабочие тесты для глобальных функций мониторинга"""
