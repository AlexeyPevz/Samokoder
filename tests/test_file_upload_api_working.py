#!/usr/bin/env python3
"""
Рабочие тесты для File Upload API
"""
...
class TestFileUploadAPIWorking:
    """Рабочие тесты для File Upload API"""
    ...
    def test_file_info_response_model(self):
        ...
        from backend.models.responses import FileInfoResponse
        ...
        assert response.file_info["file_path"] == "/uploads/test.txt"
