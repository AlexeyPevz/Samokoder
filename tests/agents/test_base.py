...
@patch("samokoder.core.agents.base.BaseLLMClient")
async def test_get_llm(mock_BaseLLMClient, mock_get_config):
    mock_get_config.return_value.llm = MagicMock()
    mock_get_config.return_value.llm.llm_for_agent.return_value = MagicMock()
