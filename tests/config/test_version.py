...
from samokoder.core.config.version import get_git_commit, get_package_version, get_version
...
@patch("samokoder.core.config.version.get_git_commit", return_value="abc")
@patch("samokoder.core.config.version.get_package_version", return_value="1.2.3")
