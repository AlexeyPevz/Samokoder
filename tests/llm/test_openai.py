...
from samokoder.core.config.config import AgentLLMConfig, LLMConfig, ProviderConfig
from samokoder.core.llm.base import APIError
from samokoder.core.llm.convo import Convo
from samokoder.core.llm.openai_client import OpenAIClient
...
def get_mock_config(model="gpt-4-turbo"):
    cfg = MagicMock()
    cfg.model = model
    cfg.temperature = 0.5
    cfg.provider = "openai"
...
@pytest.mark.asyncio
@patch("samokoder.core.llm.openai_client.AsyncOpenAI")
