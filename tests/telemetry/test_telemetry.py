...
from samokoder.core.config.config import loader
from samokoder.core.telemetry import Telemetry


@pytest_asyncio.fixture
async def mock_httpx_post():
    with patch("samokoder.core.telemetry.httpx") as mock_httpx:
...
@patch("samokoder.core.telemetry.sys.platform", "test_platform")
@patch("samokoder.core.telemetry.sys.version", "test_version")
@patch("samokoder.core.telemetry.get_version", lambda: "test_pilot_version")
...
@patch("samokoder.core.telemetry.settings")
...
@patch("samokoder.core.telemetry.getenv")
@patch("samokoder.core.telemetry.time")
@patch("samokoder.core.telemetry.settings")
...
def test_record_crash(mock_settings):
    ...
    assert "test crash" in diag["exception_message"]
