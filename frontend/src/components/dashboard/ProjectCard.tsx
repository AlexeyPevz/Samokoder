      ...
      <CardHeader className="pb-3">
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            >
              {/* Description removed as it is not on the main project model */}
            </p>
          </div>
      ...
      <CardContent className="pt-0">
        ...
        <div className="mb-4">
          {project.thumbnailUrl ? (
            <div 
              className="h-32 bg-gradient-to-br from-primary-100 to-secondary-100 rounded-lg flex items-center justify-center"
              role="img"
