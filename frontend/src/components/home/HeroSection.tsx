...
export function HeroSection({ appDescription, setAppDescription, onCreateApp, isCreating }: HeroSectionProps) {
  return (
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        >
          ...
          <Button
            ...
            className="mt-6 h-14 px-8 text-lg bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-200"
          >
            {isCreating ? (
              <>
